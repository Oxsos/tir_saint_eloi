...
CKEDITOR.editorConfig = function( config )
{
	...
	config.filebrowserBrowseUrl 		= '../inc/KCfinder/browse.php?type=files';
	config.filebrowserImageBrowseUrl 	= '../inc/KCfinder/browse.php?type=images';
	config.filebrowserFlashBrowseUrl 	= '../inc/KCfinder/browse.php?type=flash';
	config.filebrowserUploadUrl 		= '../inc/KCfinder/upload.php?type=files';
	config.filebrowserImageUploadUrl 	= '../inc/KCfinder/upload.php?type=images';
	config.filebrowserFlashUploadUrl 	= '../inc/KCfinder/upload.php?type=flash';
	// -----------------------
	/* TOOLBAR (intégré) */
	//	config.toolbar = 'Full';
